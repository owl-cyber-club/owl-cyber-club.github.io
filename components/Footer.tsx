      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 text-gray-400 hover:text-[#E1306C] transition-colors"
          >
            <span className="p-2 rounded-full bg-white/5 group-hover:bg-[#E1306C]/20 group-hover:text-[#E1306C] transition-colors">
              <svg
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="hidden md:inline group-hover:text-[#E1306C] transition-colors">
              Instagram
            </span>
          </a>
        </div>
