      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-2">
            © 2026 OWL Cyber Club. All systems operational.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch gap-6">
          ...
          <motion.button
            ...
            className={`group relative h-20 px-6 py-3 border rounded-xl flex items-center gap-3 transition-all duration-300 overflow-hidden ${
              highlightJoinLinks
          ...
          <div className="relative">
            ...
            <div
              className={`
              relative h-20 border-2 rounded-2xl px-5 py-3 flex items-center
